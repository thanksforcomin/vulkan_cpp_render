...
layout(std140, set = 1, binding = 0) uniform CameraUbo // FIXME: change back to uniform
{
    mat4 view;
    mat4 proj;
    mat4 projview;
...
layout(std140, set = 2, binding = 1) uniform PointLights // FIXME: change back to uniform // readonly buffer PointLights
{
	int light_num;
