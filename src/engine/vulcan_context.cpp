...
namespace engine {
    VulkanContext::VulkanContext() : instance(init_vulkan()),
                                     window(instance),
    ...
    void VulkanContext::create_main_pipeline(Shader &vert_shader, Shader &frag_shader) {
        //shader stages
        ...
        viewport.x = 0.0f;
        viewport.y = 0.0f;
        viewport.width = (float)swap_chain.swap_chain_extent.width;
        viewport.height = (float)swap_chain.swap_chain_extent.height;
        viewport.minDepth = 0.0f;
        viewport.maxDepth = 1.0f;

        VkRect2D scissors{};
        scissors.extent = swap_chain.swap_chain_extent;
        scissors.offset = {0, 0};
        ...
        vkDestroyShaderModule(device.logical, vert_shader.shader_module, nullptr);
        vkDestroyShaderModule(device.logical, frag_shader.shader_module, nullptr);
    }
