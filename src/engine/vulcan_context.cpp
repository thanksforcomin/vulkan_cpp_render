...
namespace engine {
    ...
    QueueFamilyIndicies VulkanContext::find_queue_family(const VkPhysicalDevice &dev) {
    ...
    swap_chain_support_details VulkanContext::query_swap_chain_support() { //because it may be useful
        swap_chain_support_details details;
